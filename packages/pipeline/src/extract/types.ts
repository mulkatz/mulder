...
export type PrimaryExtractionMethod = 'native' | 'document_ai' | 'text' | 'docx' | 'spreadsheet' | 'email';
...
export interface LayoutDocument {
	sourceId: string;
	pageCount: number;
	primaryMethod: Exclude<PrimaryExtractionMethod, 'text' | 'docx' | 'spreadsheet' | 'email'>;
	extractedAt: string;
	pages: LayoutPage[];
	metadata: {
		visionFallbackCount: number;
