  ...
  return (
    <header className="sticky top-0 z-30 flex h-[var(--topbar-height)] min-w-0 items-center gap-3 overflow-hidden border-b border-border bg-panel/95 px-3 backdrop-blur sm:px-4">
      ...
      <div className="hidden min-w-0 flex-1 items-center gap-3 md:flex">
        ...
        <button className="field hidden h-9 items-center gap-2 px-3 text-sm text-text-muted transition-colors hover:bg-field-hover lg:inline-flex" type="button">
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <button className="hidden h-9 items-center gap-2 rounded-md border border-border bg-panel px-3 text-sm text-text transition-colors hover:bg-field sm:inline-flex" type="button">
          <Plus className="size-4 text-accent" />
          New run
        </button>
        <button className="hidden h-9 items-center gap-2 rounded-md border border-border bg-field px-2 text-sm text-text min-[480px]:flex sm:px-3" type="button">
          <span className="flex size-5 items-center justify-center rounded-sm bg-accent font-mono text-[11px] text-text-inverse">M</span>
