...
const toneByStatus: Record<string, string> = {
	...
	not_started: 'bg-field text-text-muted border-border',
	pending: 'bg-field text-text-muted border-border',
	queued: 'bg-field text-text-muted border-border',
	skipped: 'bg-field text-text-muted border-border',
	...
	ingested: 'bg-field text-text-muted border-border',
	extracted: 'bg-info-soft text-info border-info/20',
	segmented: 'bg-info-soft text-info border-info/20',
	enriched: 'bg-warning-soft text-warning border-warning/20',
	embedded: 'bg-success-soft text-success border-success/20',
	graphed: 'bg-success-soft text-success border-success/20',
	analyzed: 'bg-success-soft text-success border-success/20',
