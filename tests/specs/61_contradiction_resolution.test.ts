...
describe('Spec 61 — Contradiction Resolution', () => {
	...
	it('CLI-08: --evidence-chains exits non-zero when no thesis input is configured', () => {
	...
	it('CLI-09: --spatio-temporal now succeeds as a no-op when no clusterable events exist', () => {
		if (!pgAvailable) return;
